# Projetos de Extensão — ADS (Descomplica)

Este repositório reúne meus Projetos de Extensão (PEX I–V), desenvolvidos no curso de Análise e Desenvolvimento de Sistemas, com continuidade no projeto **Aurora** e no portal **Aprenda Fácil**.

## 📌 Projetos
- [PEX 01 — Aprenda Fácil](./pex-01)
...
](https://github.com/Amanda-AAndrade/aprenda-facil-pex/tree/main)
